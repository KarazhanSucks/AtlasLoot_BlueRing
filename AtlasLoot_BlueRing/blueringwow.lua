...
---- PvP Level 40 Rare Sets
	...
	AtlasLoot_Data["LostCity1"] = {
		{  1, 0, "INV_Box_01", "=q6="..BabbleBoss["General Husam"], ""};
		{  2, 634, "", "=q3=Kaleki Cloak", "=ds=#s4#", "", "20%"};
		{  3, 633, "", "=q3=Ionic Gloves", "=ds=#s9#, #a3#", "", "20%"};
		{  4, 632, "", "=q3=Greaves of Wu the Elder", "=ds=#s12#, #a4#", "", "20%"};
		{  5, 635, "", "=q3=Spirit Creeper Ring", "=ds=#s13#", "", "20%"};
		{  6, 636, "", "=q3=Seliza's Spear", "=ds=#w7#", "", "20%"};
			{  8, 0, "INV_Box_01", "=q6="..BabbleBoss["Lockmaw"], ""};
			{  9, 642, "", "=q3=Sand Silk Wristband", "=ds=#s8#, #a1#", "", "20%"};
			{ 10, 643, "", "=q3=Sand Dune Belt", "=ds=#s10#, #a4#", "", "20%"};
			{ 11, 645, "", "=q3=Veneficial Band", "=ds=#s13#", "", "20%"};
			{ 12, 644, "", "=q3=Heart of Solace", "=ds=#s14#", "", "20%"};
			{ 13, 646, "", "=q3=Barim's Main Gauche", "=ds=#h1#, #w4#", "", "20%"};
		{ 16, 0, "INV_Box_01", "=q6="..BabbleBoss["High Prophet Barim"], ""};
		{ 17, 637, "", "=q3=Balkar's Waders", "=ds=#s11#, #a3#", "", "20%"};
		{ 18, 638, "", "=q3=Greaves of Wu the Younger", "=ds=#s12#, #a4#", "", "20%"};
		{ 19, 640, "", "=q3=Tauntka's Necklace", "=ds=#s2#", "", "20%"};
		{ 20, 639, "", "=q3=Ring of the Darkest Day", "=ds=#s13#", "", "20%"};
		{ 21, 641, "", "=q3=Resonant Kris", "=ds=#h1#, #w10#", "", "20%"};
		Next = "LostCity2";
	};

	AtlasLoot_Data["LostCity2"] = {
		{ 1, 0, "INV_Box_01", "=q6="..BabbleBoss["Siamat"], ""};
		{ 2, 649, "", "=q3=Geordan's Cloak", "=ds=#s4#", "", "20%"};
		{ 3, 653, "", "=q3=Mantle of Master Cho", "=ds=#s3#, #a1#", "", "20%"};
		{ 4, 655, "", "=q3=Evelyn's Belt", "=ds=#s10#, #a1#", "", "20%"};
		{ 5, 654, "", "=q3=Leggings of the Path", "=ds=#s11#, #a2#", "", "20%"};
		{ 6, 648, "", "=q3=Crafty's Gaiters", "=ds=#s12#, #a2#", "", "20%"};
		{ 7, 650, "", "=q3=Ring of Three Lights", "=ds=#s13#", "", "20%"};
		{ 8, 651, "", "=q3=Tia's Grace", "=ds=#s14#", "", "20%"};
		{ 9, 656, "", "=q3=Sorrowsong", "=ds=#s14#", "", "20%"};
		{ 10, 652, "", "=q3=Hammer of Sparks", "=ds=#h1#, #w6#", "", "20%"};
		{ 11, 657, "", "=q3=Zora's Ward", "=ds=#w8#", "", "20%"};
		Prev = "LostCity1";
	};
		-------------------------
		--- Ragefire Chasm 40 ---
	...
	AtlasLoot_Data["P3GLYPHS1"] = {
		--Druid
		{   1, "40896", "", "=q1=Glyph of Frenzied Regeneration",	"10 #normaltrinket#" };
		{   2, "40920", "", "=q1=Glyph of Hurricane",				"10 #normaltrinket#" };
		{   3, "40908", "", "=q1=Glyph of Innervate",				"10 #normaltrinket#" };
		{   4, "46372", "", "=q1=Glyph of Survival Instincts",		"10 #normaltrinket#" };
		--Hunter
		{   6, "42905", "", "=q1=Glyph of Freezing Trap",			"10 #normaltrinket#" };
		--Mage
		{   8, "42739", "", "=q1=Glyph of Fireball",				"10 #normaltrinket#" };
		{   9, "42752", "", "=q1=Glyph of Polymorph",				"10 #normaltrinket#" };
		--Paladin
		{  11, "41103", "", "=q1=Glyph of Exorcism",				"10 #normaltrinket#" };
		{  12, "41105", "", "=q1=Glyph of Flash of Light",			"10 #normaltrinket#" };
		{  13, "41094", "", "=q1=Glyph of Seal of Command",			"10 #normaltrinket#" };
		{  14, "41110", "", "=q1=Glyph of Seal of Light",			"10 #normaltrinket#" };
		--Priest
		{  16, "42397", "", "=q1=Glyph of Dispel Magic",			"10 #normaltrinket#" };
		{  17, "42399", "", "=q1=Glyph of Fear Ward",				"10 #normaltrinket#" };
		{  18, "42401", "", "=q1=Glyph of Holy Nova",				"10 #normaltrinket#" };
		--Rogue
		{  20, "42963", "", "=q1=Glyph of Feint",					"10 #normaltrinket#" };
		{  21, "42973", "", "=q1=Glyph of Slice and Dice",			"10 #normaltrinket#" };
		{  22, "42974", "", "=q1=Glyph of Sprint",					"10 #normaltrinket#" };
		--Shaman
		{  24, "41527", "", "=q1=Glyph of Earthliving Weapon",		"10 #normaltrinket#" };
		{  25, "41526", "", "=q1=Glyph of Shocking",				"10 #normaltrinket#" };
		{  26, "45778", "", "=q1=Glyph of Stoneclaw Totem",			"10 #normaltrinket#" };
		{  27, "41541", "", "=q1=Glyph of Water Mastery",			"10 #normaltrinket#" };
		{  28, "41542", "", "=q1=Glyph of Windfury Weapon",			"10 #normaltrinket#" };
		Next = "P3GLYPHS2";
		Back = "BRP3COLLECTIONMENU";
	};
	AtlasLoot_Data["P3GLYPHS2"] = {
		--Warlock
		{   1, "45785", "", "=q1=Glyph of Life Tap",				"10 #normaltrinket#" };
		{   2, "42468", "", "=q1=Glyph of Shadowburn",				"10 #normaltrinket#" };
		{   3, "45789", "", "=q1=Glyph of Soul Link",				"10 #normaltrinket#" };
		{   4, "42470", "", "=q1=Glyph of Soulstone",				"10 #normaltrinket#" };
		--Warrior
		{   6, "43414", "", "=q1=Glyph of Cleaving",				"10 #normaltrinket#" };
		{   7, "43430", "", "=q1=Glyph of Resonating Power",		"10 #normaltrinket#" };
		{   8, "45797", "", "=q1=Glyph of Shield Wall",				"10 #normaltrinket#" };
		{   9, "43428", "", "=q1=Glyph of Sweeping Strike",			"10 #normaltrinket#" };
		{  10, "43432", "", "=q1=Glyph of Whirlwind",				"10 #normaltrinket#" };
		Prev = "P3GLYPHS1";
		Back = "BRP3COLLECTIONMENU";
	};
