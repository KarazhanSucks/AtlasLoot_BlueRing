...
function AtlasLoot_FixText(text)
    ...
    -- Text Colouring
    text = gsub(text, "=q0=", "|cff9d9d9d");  --Gray			Poor
    text = gsub(text, "=q1=", "|cffFFFFFF");  --White			Common
    text = gsub(text, "=q2=", "|cff1eff00");  --Green			Uncommon
    text = gsub(text, "=q3=", "|cff0070dd");  --Blue			Rare
    text = gsub(text, "=q4=", "|cffa335ee");  --Purple			Epic
    text = gsub(text, "=q5=", "|cffFF8000");  --Orange			Legendary
    text = gsub(text, "=q6=", "|cffFF0000");  --Red				Rage
    text = gsub(text, "=q7=", "|cffe6cc80");  --Light Gold		Artifact
    text = gsub(text, "=ec1=", "|cffFF8400"); --brown/orange
    text = gsub(text, "=ds=", "|cffFFd200");  --yellow
