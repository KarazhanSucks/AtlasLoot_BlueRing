...
--		{ 23, "BRP2PVPAccess_A",	"inv_jewelry_trinketpvp_01",	"=ds="..AL["PvP Accessories"],					"=q5="..AL["Level 30 Bracket"]};		
	...
	AtlasLoot_Data["BRP3COLLECTIONMENU"] = {
	
		{ 2, "BRP3WorldRares20",			"INV_BOOTS_WOLF",		"=q3="..AL["BoE Dungeon Rares"],	"=ds="..AL["Level 20 Bracket"]};
		{ 3, "P3WorldRares30OnlyNormal1",	"INV_HELMET_16",		"=q3="..AL["BoE World Rares"],		"=ds="..AL["Level 30 Bracket"]};
		{ 4, "BRP3WorldRares30",			"INV_MISC_ORB_01",		"=q3="..AL["BoE Dungeon Rares"],	"=ds="..AL["Level 30 Bracket"]};
		
		--{ 6, "BRP3PVPMENU",					"INV_Axe_02",			"=ds="..AL["PvP Rewards"],			""};
